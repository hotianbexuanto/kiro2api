...
// hasValidContent 检查是否有任何有效内容
func (are *AssistantResponseEvent) hasValidContent() bool {
	return are.Content != "" ||
		are.CodeQuery != nil ||
...
// validateEnums 验证枚举值
func (are *AssistantResponseEvent) validateEnums() error {
	if are.MessageStatus != "" {
